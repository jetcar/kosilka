...
data class MapUiState(
    ...
    val selectedAvailableZoneIndex: Int = 0,
    val noGoZones: List<Zone> = emptyList(),
    val zone: Zone? = null,
    val coverageChunks: List<CoverageChunk> = emptyList(),
    val expectedCoverageSegments: List<CoverageSegment> = emptyList(),
    val sweepWidthMm: Int = 350,
